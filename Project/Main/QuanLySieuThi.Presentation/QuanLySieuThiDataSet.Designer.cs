...
namespace QuanLySieuThi.Presentation {
    ...
    public partial class QuanLySieuThiDataSet : global::System.Data.DataSet {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MaNhanVien, string HoTen, System.DateTime NgaySinh, string GioiTinh, string CMND, string DiaChi, string DienThoai, System.DateTime NgayVaoLam, string MaChucVu, string TenDangNhap, string MatKhau) {
...
namespace QuanLySieuThi.Presentation.QuanLySieuThiDataSetTableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NHANVIEN] WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ((@IsNull_HoTen = 1 AND [HoTen] IS NULL) OR ([HoTen] = @Original_HoTen)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_CMND = 1 AND [CMND] IS NULL) OR ([CMND] = @Original_CMND)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ((@IsNull_MaChucVu = 1 AND [MaChucVu] IS NULL) OR ([MaChucVu] = @Original_MaChucVu)) AND ((@IsNull_TenDangNhap = 1 AND [TenDangNhap] IS NULL) OR ([TenDangNhap] = @Original_TenDangNhap)) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NHANVIEN] ([MaNhanVien], [HoTen], [NgaySinh], [GioiTinh], [CMND], [DiaChi], [DienThoai], [NgayVaoLam], [MaChucVu], [TenDangNhap], [MatKhau]) VALUES (@MaNhanVien, @HoTen, @NgaySinh, @GioiTinh, @CMND, @DiaChi, @DienThoai, @NgayVaoLam, @MaChucVu, @TenDangNhap, @MatKhau);
SELECT MaNhanVien, HoTen, NgaySinh, GioiTinh, CMND, DiaChi, DienThoai, NgayVaoLam, MaChucVu, TenDangNhap, MatKhau FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MaNhanVien] = @MaNhanVien, [HoTen] = @HoTen, [NgaySinh] = @NgaySinh, [GioiTinh] = @GioiTinh, [CMND] = @CMND, [DiaChi] = @DiaChi, [DienThoai] = @DienThoai, [NgayVaoLam] = @NgayVaoLam, [MaChucVu] = @MaChucVu, [TenDangNhap] = @TenDangNhap, [MatKhau] = @MatKhau WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ((@IsNull_HoTen = 1 AND [HoTen] IS NULL) OR ([HoTen] = @Original_HoTen)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_CMND = 1 AND [CMND] IS NULL) OR ([CMND] = @Original_CMND)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_DienThoai = 1 AND [DienThoai] IS NULL) OR ([DienThoai] = @Original_DienThoai)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ((@IsNull_MaChucVu = 1 AND [MaChucVu] IS NULL) OR ([MaChucVu] = @Original_MaChucVu)) AND ((@IsNull_TenDangNhap = 1 AND [TenDangNhap] IS NULL) OR ([TenDangNhap] = @Original_TenDangNhap)) AND ((@IsNull_MatKhau = 1 AND [MatKhau] IS NULL) OR ([MatKhau] = @Original_MatKhau)));
SELECT MaNhanVien, HoTen, NgaySinh, GioiTinh, CMND, DiaChi, DienThoai, NgayVaoLam, MaChucVu, TenDangNhap, MatKhau FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLySieuThi.Presentation.Properties.Settings.Default.QuanLySieuThiConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNhanVien, HoTen, NgaySinh, GioiTinh, CMND, DiaChi, DienThoai, NgayVaoLam" +
                ", MaChucVu, TenDangNhap, MatKhau FROM dbo.NHANVIEN";
        ...
        public virtual int Delete(string Original_MaNhanVien, string Original_HoTen, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_GioiTinh, string Original_CMND, string Original_DiaChi, string Original_DienThoai, global::System.Nullable<global::System.DateTime> Original_NgayVaoLam, string Original_MaChucVu, string Original_TenDangNhap, string Original_MatKhau) {
            ...
            if ((Original_MaChucVu == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((string)(Original_MaChucVu));
            }
        ...
        public virtual int Insert(string MaNhanVien, string HoTen, global::System.Nullable<global::System.DateTime> NgaySinh, string GioiTinh, string CMND, string DiaChi, string DienThoai, global::System.Nullable<global::System.DateTime> NgayVaoLam, string MaChucVu, string TenDangNhap, string MatKhau) {
            if ((MaNhanVien == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_MaChucVu == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((string)(Original_MaChucVu));
            }
            if ((Original_TenDangNhap == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[29].Value = ((string)(Original_TenDangNhap));
            }
            if ((Original_MatKhau == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[31].Value = ((string)(Original_MatKhau));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_TenDangNhap, 
                    string Original_MatKhau) {
            return this.Update(Original_MaNhanVien, HoTen, NgaySinh, GioiTinh, CMND, DiaChi, DienThoai, NgayVaoLam, MaChucVu, TenDangNhap, MatKhau, Original_MaNhanVien, Original_HoTen, Original_NgaySinh, Original_GioiTinh, Original_CMND, Original_DiaChi, Original_DienThoai, Original_NgayVaoLam, Original_MaChucVu, Original_TenDangNhap, Original_MatKhau);
        }
    }
