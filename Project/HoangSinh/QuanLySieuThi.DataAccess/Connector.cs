...
namespace QuanLySieuThi.DataAccess
{
    public class Connector
    {
        ...
        private static object[] Binding(object info)
        {
            ...
            //return prop.Select(delegate(PropertyInfo propertyInfo)
            //{
            //    return propertyInfo.GetValue(info, null);
            //}).ToArray();
        ...
        public SqlDataReader GetDataFromRowSelected(string sql)
        {
            
            try
            {
                SqlCommand selectCmd = new SqlCommand(sql, _connect);
        ...
        internal DataTable Search(string p)
        {
